...
A statement on reusing the source code of the hmmlearn package, by the requirement of the copyrigh holders of hmmlearn, is available in the filefolder statement_hmmlearn. A list of the authors of the hmmlearn package, as complementary to the statement, is also included.
